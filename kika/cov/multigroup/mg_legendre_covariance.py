"""
Multigroup Legendre-coefficient covariance data structure.

This module contains the MultigroupLegendreCovariance class for storing
multigroup covariance matrices of Legendre expansion coefficients.
"""
...
@dataclass
class MultigroupLegendreCovariance:
    """
    Multigroup covariance of Legendre expansion coefficients.
    
    This class stores multigroup covariance matrices derived from MF34 data,
    maintaining similar structure to LegendreCovariance but for multigroup data.
    ...
    def to_dataframe(self) -> pd.DataFrame:
        ...
        This method creates a DataFrame with the same format as LegendreCovariance.to_dataframe()
        ...
        # Create DataFrame with same column names as LegendreCovariance
        data = {
    ...
    def filter_by_isotope_reaction(self, isotope: int, mt: int) -> "MultigroupLegendreCovariance":
        """
        Return a new MultigroupLegendreCovariance containing only matrices for the specified isotope and MT reaction.
        ...
        MultigroupLegendreCovariance
            New MultigroupLegendreCovariance object containing only the filtered matrices
        """
        ...
        # Create new MultigroupLegendreCovariance with filtered data
        filtered_mg = MultigroupLegendreCovariance()
    ...
    def reactions_by_isotope(self, isotope: Optional[int] = None) -> Union[Dict[int, List[int]], List[int]]:
        ...
        This method provides compatibility with the CrossSectionCovariance interface for the sandwich uncertainty 
    ...
    def _build_uncertainty_plotdata(
        ...
        with ``LegendreCovariance.to_plot_data()``.
    ...
    def _create_uncertainty_plotdata(
        ...
        **styling_kwargs,
        ...
        import warnings
        warnings.warn(
            "MultigroupLegendreCovariance._create_uncertainty_plotdata() is deprecated. "
...
MGMF34CovMat = MultigroupLegendreCovariance  # backward compat
