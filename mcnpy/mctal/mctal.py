...
class MCTAL:
    ...
    def __post_init__(self):
        ...
        if self.tally is None:
            self.tally = {}  # Initialize as dict instead of list
...
# New class for perturbed tally data, inheriting from Tally.
@dataclass
class TallyPert(Tally):
    # Inherits tally_id, name, energies, etc., but its own results, errors and tfc_* will be set separately.
    def __post_init__(self):
