...
def parse_mctal_file(filename, tally_ids=None, tfc=True, pert=True):
...
def parse_tally(tally_id, file_obj, start_pos, tfc=True, pert=True):
    ...
    if not pert:
        ...
        while True:
            ...
            from .mctal import TallyPert  # ensure TallyPert is imported
